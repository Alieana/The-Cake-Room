...
while($row = mysqli_fetch_array($result))
  {  ?>
  <center>
    <form action="recipeCake.php" method="get">
    <div class="row">
      <div class="column nature">
        <div class="content">
          <?php echo '<img style="width:55%" src="data:image/;base64,'.$row['cake_img'].'">';?>
          <h4 style="color: #7e4a35"><?php echo $row['cake_name'];?></h4>
          <p><a href="recipeCake.php?id=<?php echo $row['cake_id'];?>"><input type="button" name="search" value="Get Recipe"/></a></p>
        </div>
      </div>
<?php
}
...
function w3RemoveClass(element, name) {
  ...
  <audio controls autoplay>
    <source src="paris.ogg" type="audio/ogg">
      <source src="paris.mp3" type="audio/mpeg">
      </audio>
</body>
</html>